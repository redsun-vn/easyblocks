...
describe("preOrderPathComparator", () => {
    ...
    `("given $a and $b to compare should return $expectedOutput ", ({ a, b, expectedOutput }) => {
    ...
    `("given $a and $b to compare should throw error", ({ a, b }) => {
            expect(() => preOrderPathComparator()(a, b)).toThrowError(`Cannot compare paths '${a}' and '${b}'.`);
        });
    });
});
//# sourceMappingURL=preOrderPathComparator.test.js.map