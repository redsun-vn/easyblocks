...
var tinaFieldProviders = {
  ...
  custom: function custom(schemaProp, editorContext, value) {
    ...
    if (customTypeDefinition.type === "token") {
      var tokens = assertDefined(editorContext.theme[customTypeDefinition.token], "Missing token values within the Easyblocks config for \"".concat(customTypeDefinition.token, "\""));
