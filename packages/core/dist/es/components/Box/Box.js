...
var Box = /*#__PURE__*/React.forwardRef(function (props, ref) {
  ...
  var _useMemo = useMemo(function () {
       ...
       */
      var correctedStyles = getBoxStyles(JSON.parse(JSON.stringify(styles)), devices);
  ...
  return /*#__PURE__*/React.createElement(as || __as || "div", _objectSpread(_objectSpread({
    ref: ref
  }, restPassedProps), {}, {
