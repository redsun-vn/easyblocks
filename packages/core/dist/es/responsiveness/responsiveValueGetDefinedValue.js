...
function responsiveValueGetFirstHigherValue(value, breakpoint, devices, widths) {
  var higherDefinedDevice = responsiveValueFindHigherDeviceWithDefinedValue(value, breakpoint, devices, widths);
...
function responsiveValueGetFirstLowerValue(value, breakpoint, devices, widths) {
  var lowerDefinedDevice = responsiveValueFindLowerDeviceWithDefinedValue(value, breakpoint, devices, widths);
...
function responsiveValueGetDefinedValue(value, breakpoint, devices, widths) {
  ...
  var definedDevice = responsiveValueFindDeviceWithDefinedValue(value, breakpoint, devices, widths);
  if (!definedDevice) {
    return;
  }
