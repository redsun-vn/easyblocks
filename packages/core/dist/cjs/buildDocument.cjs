...
function _buildDocument() {
  _buildDocument = _asyncToGenerator__default["default"](/*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee(_ref) {
    ...
    return _regeneratorRuntime__default["default"].wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          _buildEntry = buildEntry.buildEntry({
            entry: entry,
            config: config,
            locale: locale
          ...
          return _context.abrupt("return", {
            renderableDocument: {
              ...
              meta: easyblocksUtils.serialize(meta),
...
function _resolveEntryForDocument() {
  _resolveEntryForDocument = _asyncToGenerator__default["default"](/*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee2(_ref2) {
