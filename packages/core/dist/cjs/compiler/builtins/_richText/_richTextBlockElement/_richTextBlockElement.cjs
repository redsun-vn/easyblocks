...
var RICH_TEXT_BLOCK_ELEMENT_TYPES = ["bulleted-list", "numbered-list", "paragraph"];
var RICH_TEXT_BLOCK_ELEMENT_TYPE_OPTIONS = [{
...
var richTextBlockElementEditableComponent = {
