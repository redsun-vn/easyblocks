...
var designSystem = require('@easyblocks/design-system');
var isPropValid = require('@emotion/is-prop-valid');
var styled = require('styled-components');
var _extends = require('@babel/runtime/helpers/extends');
var core = require('@easyblocks/core');
var _internals = require('@easyblocks/core/_internals');
...
const IframeContainer = styled__default["default"].div.withConfig({
  displayName: "EditorIframe__IframeContainer",
  componentId: "sc-lodz39-0"
})(["position:relative;flex:1 1 auto;background:", ";"], designSystem.Colors.black100);
const IframeInnerContainer = styled__default["default"].div.withConfig({
  displayName: "EditorIframe__IframeInnerContainer",
  componentId: "sc-lodz39-1"
})(["position:absolute;top:0;left:0;width:100%;height:100%;display:grid;justify-content:center;align-items:center;"]);
const Iframe = styled__default["default"].iframe.withConfig({
  displayName: "EditorIframe__Iframe",
  componentId: "sc-lodz39-2"
...
const IdWrapper = styled__default["default"].div.withConfig({
  displayName: "SidebarFooter__IdWrapper",
  componentId: "sc-1kn8gap-0"
})(["display:block;padding:16px;", " color:", ";"], designSystem.Fonts.body, designSystem.Colors.black40);
function SidebarFooter(props) {
  ...
  return /*#__PURE__*/React__namespace.createElement("div", null, /*#__PURE__*/React__namespace.createElement(IdWrapper, null, /*#__PURE__*/React__namespace.createElement("div", null, "Id: ", value._id), /*#__PURE__*/React__namespace.createElement("br", null), showSaveAsTemplate && /*#__PURE__*/React__namespace.createElement(designSystem.ButtonSecondary, {
    onClick: () => {
  ...
  }, /*#__PURE__*/React__namespace.createElement("div", null, /*#__PURE__*/React__namespace.createElement(designSystem.ButtonPrimary, {
    onClick: () => {
...
const Toggle = _ref => {
  ...
  return /*#__PURE__*/React__default["default"].createElement(ToggleFieldWrapper, null, /*#__PURE__*/React__default["default"].createElement(designSystem.Toggle, toggleProps));
};
const ToggleFieldWrapper = styled__default["default"].div.withConfig({
  displayName: "Toggle__ToggleFieldWrapper",
  componentId: "sc-9enff5-0"
...
function toComponent(option) {
  if ("isDivider" in option) {
    return /*#__PURE__*/React__default["default"].createElement(designSystem.SelectSeparator, {
      key: "divider"
    });
  }
  return /*#__PURE__*/React__default["default"].createElement(designSystem.SelectItem, {
    key: option.value,
    value: option.value,
...
const RadioGroup = _ref => {
  ...
  return radioOptionsMapped && /*#__PURE__*/React__default["default"].createElement(designSystem.SelectInline, _extends__default["default"]({}, input, {
    value: toggleButtonValue
  }), radioOptionsMapped.map(option => {
    let Icon = undefined;
    if (typeof option.icon === "string" && option.icon in designSystem.Icons) {
      Icon = designSystem.Icons[option.icon];
    }
    if (typeof option.icon === "function") {
      Icon = option.icon;
    }
    return /*#__PURE__*/React__default["default"].createElement(designSystem.ToggleButton, {
      key: option.value,
      icon: Icon,
      value: option.value,
...
const NumberInput = _ref => {
  ...
  return /*#__PURE__*/React__namespace.createElement(designSystem.Input, {
    type: "number"
...
const TooltipBody = styled__default["default"].div.withConfig({
  displayName: "Tooltip__TooltipBody",
  componentId: "sc-1gkryiq-0"
})(["position:relative;top:6px;display:flex;flex-direction:row;justify-content:center;align-items:center;padding:6px 4px;background:#333333;border-radius:2px;", " color:#fff;"], designSystem.Fonts.body);
const TooltipArrow = styled__default["default"].div.withConfig({
  displayName: "Tooltip__TooltipArrow",
  componentId: "sc-1gkryiq-1"
...
function FieldMetaWrapper(_ref) {
  ...
  const content = /*#__PURE__*/React__default["default"].createElement(_StyledDiv$5, {
    $_css: resolvedLayout === "row" ? "flex-end" : "flex-start"
  ...
  const externalValues = isExternalField ? configs.map(c => externalData[core.getExternalReferenceLocationKey(focussedField.length === 0 ? "$" : c._id, schemaProp.prop, core.isTrulyResponsiveValue(input.value) ? core.responsiveValueFindDeviceWithDefinedValue(input.value, editorContext.breakpointIndex, editorContext.devices)?.id : undefined)]) : undefined;
  const currentBreakpointFieldValues = fieldValues.map(v => core.responsiveValueForceGet(v, editorContext.breakpointIndex));
  const isLoadingExternalValue = isExternalField && externalValues?.length === 0 && currentBreakpointFieldValues.every(v => !core.isEmptyExternalReference(v) && !core.isIdReferenceToDocumentExternalValue(v.id));
  return /*#__PURE__*/React__default["default"].createElement(FieldWrapper, {
  ...
  }, triggerProps), /*#__PURE__*/React__default["default"].createElement(_StyledSpan$1, null, label), isOpen && /*#__PURE__*/React__default["default"].createElement(Tooltip, tooltipProps, /*#__PURE__*/React__default["default"].createElement(TooltipArrow, arrowProps), /*#__PURE__*/React__default["default"].createElement(TooltipBody, null, field.description))), isLoadingExternalValue && /*#__PURE__*/React__default["default"].createElement(_StyledLoader, null), resolvedLayout === "column" && (_internals.isExternalSchemaProp(schemaProp, editorContext.types) || schemaProp.type === "text") && !isMixedValue && /*#__PURE__*/React__default["default"].createElement(WidgetsSelect, {
    ...
    onChange: widgetId => {
      ...
      if (core.isTrulyResponsiveValue(input.value)) {
        const newFieldValue = {
          ...input.value,
...
function WidgetsSelect(_ref2) {
  ...
  return /*#__PURE__*/React__default["default"].createElement(FieldLabelIconWrapper, null, /*#__PURE__*/React__default["default"].createElement(designSystem.Select, {
...
const TextButton = styled__default["default"](designSystem.Typography).withConfig({
  displayName: "wrapFieldWithMeta__TextButton",
  componentId: "sc-10gicmp-0"
...
const FieldWrapper = styled__default["default"].div.withConfig({
  displayName: "wrapFieldWithMeta__FieldWrapper",
  componentId: "sc-10gicmp-1"
  ...
  return layout === "column" && styled.css(["flex-grow:1;"]);
});
const FieldLabelWrapper = styled__default["default"].div.withConfig({
  displayName: "wrapFieldWithMeta__FieldLabelWrapper",
  componentId: "sc-10gicmp-2"
...
const FieldLabel = styled__default["default"].label.withConfig({
  ...
  componentId: "sc-10gicmp-3"
})(["all:unset;", ";color:", ";text-overflow:ellipsis;overflow:hidden;cursor:default;"], designSystem.Fonts.body, _ref7 => {
  let {
    isError
  } = _ref7;
  return isError ? "red" : "#000";
});
const FieldLabelIconWrapper = styled__default["default"].span.withConfig({
  displayName: "wrapFieldWithMeta__FieldLabelIconWrapper",
  componentId: "sc-10gicmp-4"
})(["display:flex;font-size:14px;line-height:1;margin-left:auto;padding-left:8px;svg{width:14px;height:14px;flex-shrink:0;}"]);
const FieldError = styled__default["default"].span.withConfig({
  displayName: "wrapFieldWithMeta__FieldError",
  componentId: "sc-10gicmp-5"
})(["display:block;color:red;font-size:var(--tina-font-size-1);margin-top:8px;font-weight:var(--tina-font-weight-regular);"]);
const FieldInputWrapper = styled__default["default"].div.withConfig({
  displayName: "wrapFieldWithMeta__FieldInputWrapper",
  componentId: "sc-10gicmp-6"
})(["display:flex;justify-content:flex-end;align-items:center;", ";min-height:28px;"], _ref8 => {
  let {
    layout
  } = _ref8;
  return layout === "row" ? styled.css(["flex-grow:1;"]) : styled.css(["width:100%;"]);
});
var _StyledDiv$5 = styled__default["default"]("div").withConfig({
  displayName: "wrapFieldWithMeta___StyledDiv",
  componentId: "sc-10gicmp-7"
})(["width:100%;display:flex;align-items:", ";flex-direction:column;"], p => p.$_css);
var _StyledSpan$1 = styled__default["default"]("span").withConfig({
  displayName: "wrapFieldWithMeta___StyledSpan",
  componentId: "sc-10gicmp-8"
})(["line-height:100%;overflow:hidden;text-overflow:ellipsis;"]);
var _StyledLoader = styled__default["default"](designSystem.Loader).withConfig({
  displayName: "wrapFieldWithMeta___StyledLoader",
  componentId: "sc-10gicmp-9"
})(["margin-left:6px;"]);
...
function TextField(_ref) {
  ...
  return /*#__PURE__*/React__default["default"].createElement(FieldMetaWrapper, {
    ...
    noWrap: noWrap
  }, /*#__PURE__*/React__default["default"].createElement(designSystem.Input, _extends__default["default"]({}, restInputProperties, inputProps, {
...
function TokenFieldComponent(_ref) {
  ...
  const isExtraValueSelected = !isMixedFieldValue(input.value) && !input.value.tokenId && extraValuesIncludes(extraValues, core.responsiveValueGetDefinedValue(input.value.value, editorContext.breakpointIndex, editorContext.devices, core.getDevicesWidths(editorContext.devices) /** FOR NOW TOKENS ARE RELATIVE TO SCREEN **/));
  ...
  const onSelectChange = selectedValue => {
    if (selectedValue === CUSTOM_OPTION_VALUE) {
      ...
      if (core.isTrulyResponsiveValue(value)) {
        value = core.responsiveValueGetDefinedValue(
        // Not sure about usage of responsiveValueGet without widths
        value, editorContext.breakpointIndex, editorContext.devices, core.getDevicesWidths(editorContext.devices) /** FOR NOW TOKENS ARE RELATIVE TO SCREEN **/);
      }
      input.onChange({
        value,
  ...
  if (tokenTypeDefinition.token === "colors") {
    return /*#__PURE__*/React__default["default"].createElement(React.Fragment, null, /*#__PURE__*/React__default["default"].createElement(designSystem.Select, {
      value: selectValue,
      ...
      value: MIXED_VALUE,
      isDisabled: true
    }, "Mixed"), /*#__PURE__*/React__default["default"].createElement(designSystem.SelectSeparator, null)), /*#__PURE__*/React__default["default"].createElement(React.Fragment, null, options.map(o => {
    ...
    }), allowCustom && /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, /*#__PURE__*/React__default["default"].createElement(designSystem.SelectSeparator, null), /*#__PURE__*/React__default["default"].createElement(SelectColorTokenItem, {
      value: CUSTOM_OPTION_VALUE,
      previewColor: selectValue === CUSTOM_OPTION_VALUE ? input.value.value : undefined
    }, "Custom")))), customInputElement);
  }
  return /*#__PURE__*/React__default["default"].createElement(Root, null, /*#__PURE__*/React__default["default"].createElement(designSystem.Select, {
    value: selectValue,
    onChange: onSelectChange
  }, isMixedFieldValue(input.value) && /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, /*#__PURE__*/React__default["default"].createElement(designSystem.SelectItem, {
    value: MIXED_VALUE,
    isDisabled: true
  }, "Mixed"), /*#__PURE__*/React__default["default"].createElement(designSystem.SelectSeparator, null)), selectValue === CUSTOM_OPTION_VALUE && !allowCustom && /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, /*#__PURE__*/React__default["default"].createElement(designSystem.SelectItem, {
    value: CUSTOM_OPTION_VALUE,
    isDisabled: true
  }, "Custom"), /*#__PURE__*/React__default["default"].createElement(designSystem.SelectSeparator, null)), /*#__PURE__*/React__default["default"].createElement(React.Fragment, null, options.map(o => {
    return /*#__PURE__*/React__default["default"].createElement(designSystem.SelectItem, {
      key: o.id,
      value: o.id
    }, o.label);
  }), allowCustom && /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, /*#__PURE__*/React__default["default"].createElement(designSystem.SelectSeparator, null), /*#__PURE__*/React__default["default"].createElement(designSystem.SelectItem, {
    value: CUSTOM_OPTION_VALUE
  }, "Custom")))), customInputElement);
}
function getFontTokenLabel(name, token, editorContext) {
  const filledResponsiveFontValue = core.responsiveValueFill(token.value, editorContext.devices, core.getDevicesWidths(editorContext.devices));
  const currentDeviceFontValue = core.responsiveValueForceGet(filledResponsiveFontValue, editorContext.breakpointIndex);
...
const SelectColorTokenItem = /*#__PURE__*/React.forwardRef((props, ref) => {
  return /*#__PURE__*/React__default["default"].createElement(designSystem.SelectItem, {
    ...
    ref: ref
  }, /*#__PURE__*/React__default["default"].createElement(_StyledSpan, null, /*#__PURE__*/React__default["default"].createElement("svg", {
    ...
    stroke: designSystem.Colors.black100
  })), /*#__PURE__*/React__default["default"].createElement("span", null, props.children)));
});
var _StyledSpan = styled__default["default"]("span").withConfig({
  displayName: "TokenFieldPlugin___StyledSpan",
  componentId: "sc-9ooa1v-1"
...
const BlockField = _ref => {
  ...
  return /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, !isLabelHidden && /*#__PURE__*/React__default["default"].createElement(_StyledDiv$4, null, /*#__PURE__*/React__default["default"].createElement(designSystem.Typography, null, field.label || field.name)), /*#__PURE__*/React__default["default"].createElement(_StyledDiv2$4, null, config !== null && /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, /*#__PURE__*/React__default["default"].createElement("div", {
    style: {
      flex: "1 1 auto",
      minWidth: 0
    }
  ...
  }, /*#__PURE__*/React__default["default"].createElement(designSystem.ButtonGhost, {
    onClick: () => {
    ...
    icon: designSystem.Icons.Remove,
    "aria-label": "Remove"
  }))), config === null && (isMixed ? /*#__PURE__*/React__default["default"].createElement(designSystem.ThumbnailButton, {
    label: "Mixed",
    disabled: true
...
function AddButton$1(_ref2) {
  ...
  return /*#__PURE__*/React__default["default"].createElement(_StyledButtonGhost$1, {
    onClick: onAdd,
    height: "32px",
    noPadding: true
  }, /*#__PURE__*/React__default["default"].createElement(_StyledDiv3$2, null, /*#__PURE__*/React__default["default"].createElement(_StyledDiv4, {
    $_css: designSystem.Colors.black20
  }, /*#__PURE__*/React__default["default"].createElement(designSystem.Icons.Add, {
    size: 16
  })), "Add"));
}
const SubComponentPanelButton = _ref3 => {
  ...
  return showError ? /*#__PURE__*/React__default["default"].createElement(Error$2, null, label) : /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, /*#__PURE__*/React__default["default"].createElement(designSystem.ThumbnailButton, {
    onClick: onExpand,
    label: label,
...
function getSidebarPreview(componentDefinition, entryAfterAuto, externalData, editorContext) {
  const previewValues = Object.fromEntries(componentDefinition.schema.map(s => {
    const value = core.responsiveValueForceGet(entryAfterAuto[s.prop], editorContext.breakpointIndex);
    if (_internals.isExternalSchemaProp(s, editorContext.types)) {
      const externalDataValue = core.resolveExternalValue(value, entryAfterAuto._id, s, externalData);
      return [s.prop, externalDataValue];
    }
    if (s.type === "text") {
      return [s.prop, core.resolveLocalisedValue(value.value, editorContext)?.value];
    }
    return [s.prop, value];
  }));
...
const Error$2 = styled__default["default"].div.withConfig({
  displayName: "BlockFieldPlugin__Error",
  componentId: "sc-1xayyaw-0"
})(["", " padding:7px 6px 7px;color:hsl(0deg 0% 50% / 0.8);white-space:normal;background:hsl(0deg 100% 50% / 0.2);margin-right:10px;border-radius:2px;"], designSystem.Fonts.body);
...
const PanelBody = styled__default["default"].div.withConfig({
  displayName: "BlockFieldPlugin__PanelBody",
  componentId: "sc-1xayyaw-1"
...
const GroupPanel = styled__default["default"].div.withConfig({
  displayName: "BlockFieldPlugin__GroupPanel",
  componentId: "sc-1xayyaw-2"
...
var _StyledDiv$4 = styled__default["default"]("div").withConfig({
  displayName: "BlockFieldPlugin___StyledDiv",
  componentId: "sc-1xayyaw-3"
})(["display:flex;align-items:center;padding:4px 16px;min-height:28px;"]);
var _StyledDiv2$4 = styled__default["default"]("div").withConfig({
  displayName: "BlockFieldPlugin___StyledDiv2",
  componentId: "sc-1xayyaw-4"
})(["display:flex;justify-content:space-between;align-items:center;padding:4px 16px;"]);
var _StyledButtonGhost$1 = styled__default["default"](designSystem.ButtonGhost).withConfig({
  displayName: "BlockFieldPlugin___StyledButtonGhost",
  componentId: "sc-1xayyaw-5"
})(["width:100%;padding-left:0;"]);
var _StyledDiv3$2 = styled__default["default"]("div").withConfig({
  displayName: "BlockFieldPlugin___StyledDiv3",
  componentId: "sc-1xayyaw-6"
})(["display:flex;align-items:center;gap:8px;width:100%;"]);
var _StyledDiv4 = styled__default["default"]("div").withConfig({
  displayName: "BlockFieldPlugin___StyledDiv4",
  componentId: "sc-1xayyaw-7"
})(["display:grid;place-items:center;width:32px;height:32px;margin-left:-1px;border:1px dashed ", ";border-radius:2px;"], p => p.$_css);
...
function IdentityField(_ref) {
  ...
  const titleContent = /*#__PURE__*/React__default["default"].createElement(_StyledDiv$3, null, /*#__PURE__*/React__default["default"].createElement(_StyledTypography$1, null, componentDefinition?.label ?? componentDefinition?.id), !isNonChangable && /*#__PURE__*/React__default["default"].createElement(designSystem.Icons.ChevronDown, {
    size: 16
  }));
  return /*#__PURE__*/React__default["default"].createElement(_StyledDiv2$3, null, /*#__PURE__*/React__default["default"].createElement(_StyledDiv3$1, null, isWithinNestedPanel && /*#__PURE__*/React__default["default"].createElement(_StyledButtonGhost, {
    icon: designSystem.Icons.ChevronLeft,
    onClick: () => {
  ...
  }, titleContent), !isNonChangable && /*#__PURE__*/React__default["default"].createElement(designSystem.ButtonGhost, {
    onClick: handleChangeComponentType
  }, titleContent), /*#__PURE__*/React__default["default"].createElement(_StyledButtonGhost2, {
    "aria-label": "Remove component",
    icon: designSystem.Icons.Remove,
    onClick: handleRemove,
    $_css: isNonRemovable ? 0 : 1,
    $_css2: isNonRemovable ? "none" : "auto"
  })));
}
...
var _StyledDiv$3 = styled__default["default"]("div")`
        display: flex;
        align-items: center;
        gap: 2px;
      `;
var _StyledTypography$1 = styled__default["default"](designSystem.Typography)`
          line-height: 14px;
          font-weight: 700;
        `;
var _StyledDiv2$3 = styled__default["default"]("div")`
        display: flex;
        gap: 8px;
        min-height: 28px;
        padding: 10px;
      `;
var _StyledDiv3$1 = styled__default["default"]("div")`
          display: flex;
          align-items: center;
          flex: 1 0;
        `;
var _StyledButtonGhost = styled__default["default"](designSystem.ButtonGhost)`
              margin-right: auto;
            `;
var _StyledButtonGhost2 = styled__default["default"](designSystem.ButtonGhost).withConfig({
  displayName: "IdentityFieldPlugin___StyledButtonGhost2",
  componentId: "sc-1b6fkin-0"
})(["margin-left:auto;opacity:", ";pointer-events:", ";"], p => p.$_css, p => p.$_css2);

function MissingWidget(props) {
  return /*#__PURE__*/React__default["default"].createElement(designSystem.Typography, null, "Missing widget for type \"", props.type, "\".");
}
...
const ExternalFieldComponent = props => {
  ...
  const externalReferenceLocationKey = core.getExternalReferenceLocationKey(configId, field.schemaProp.prop, field.schemaProp.responsive ? editorContext.breakpointIndex : undefined);
  const externalValue = externalReferenceLocationKey ? externalData[externalReferenceLocationKey] : undefined;
  const isExternalValueResolvedCompoundExternalDataValue = !isMixedFieldValue(value) && !core.isEmptyExternalReference(value) && externalValue !== undefined && core.isResolvedCompoundExternalDataValue(externalValue);
  ...
  const isCompoundResourceValueSelectVisible = isExternalValueResolvedCompoundExternalDataValue && !core.isIdReferenceToDocumentExternalValue(value.id) && basicResources.length > 1;
  ...
  return /*#__PURE__*/React__default["default"].createElement(FieldMetaWrapper, _extends__default["default"]({}, props, {
    form: tinaForm,
    layout: "column"
  }), /*#__PURE__*/React__default["default"].createElement(_StyledDiv$2, null, isMixedFieldValue(value) ? "Mixed" : /*#__PURE__*/React__default["default"].createElement(_StyledDiv2$2, null, ExternalField ? /*#__PURE__*/React__default["default"].createElement(ExternalField, {
    id: value.id,
...
var _StyledDiv$2 = styled__default["default"]("div")`
          width: 100%;
        `;
var _StyledDiv2$2 = styled__default["default"]("div").withConfig({
  displayName: "ExternalField___StyledDiv2",
  componentId: "sc-13mu2x6-0"
...
function getSavedValue(value, previousValue, editorContext) {
  ...
  if (!core.isTrulyResponsiveValue(previousValue)) {
...
function responsiveFieldController(config) {
  ...
  const isResponsive = fieldValues.every(fieldValue => core.isTrulyResponsiveValue(fieldValue));
  ...
  const format = (value, name) => {
    ...
    const displayedValue = (core.isTrulyResponsiveValue(valueAfterFormat) ? valueAfterFormat[editorContext.breakpointIndex] : valueAfterFormat) ?? null;
  ...
  const toggleOffAuto = () => {
    ...
    const newFieldsValues = normalizedFieldName.map(fieldName => {
      ...
      const newFieldValue = {
        ...fieldValue,
        [editorContext.breakpointIndex]: core.responsiveValueForceGet(
...
const ResponsiveField = props => {
  ...
  const scalarFieldValues = fieldValues.map(fieldValue => {
    return core.responsiveValueForceGet(
  ...
  return /*#__PURE__*/React__default["default"].createElement(FieldMetaWrapper, _extends__default["default"]({}, props, {
    ...
    renderLabel: isValueDifferentFromMainBreakpoint ? _ref => {
      ...
      }, triggerProps), /*#__PURE__*/React__default["default"].createElement(designSystem.Icons.Reset, null), /*#__PURE__*/React__default["default"].createElement(ResetButtonLabel, null, label), isOpen && /*#__PURE__*/React__default["default"].createElement(Tooltip, tooltipProps, /*#__PURE__*/React__default["default"].createElement(TooltipArrow, arrowProps), /*#__PURE__*/React__default["default"].createElement(TooltipBody, null, "Revert to auto")));
    } : undefined
...
const AutoLabel = styled__default["default"].div.withConfig({
  displayName: "ResponsiveFieldPlugin__AutoLabel",
  componentId: "sc-1wk22qg-0"
})(["", ";color:", ";text-align:", ";&:hover{color:black;cursor:pointer;text-decoration:underline;}"], designSystem.Fonts.body, designSystem.Colors.black40, props => props.align);
const ResetButton = styled__default["default"].button.withConfig({
  displayName: "ResponsiveFieldPlugin__ResetButton",
  componentId: "sc-1wk22qg-1"
})(["display:flex;align-items:center;gap:4px;background-color:transparent;border:0;padding:0;color:", ";cursor:pointer;"], designSystem.Colors.purple);
const ResetButtonLabel = styled__default["default"].span.withConfig({
  displayName: "ResponsiveFieldPlugin__ResetButtonLabel",
  componentId: "sc-1wk22qg-2"
})(["", ";line-height:16px;"], designSystem.Fonts.body);
...
const Slider = wrapFieldsWithMeta(_ref => {
  ...
  return /*#__PURE__*/React__default["default"].createElement(designSystem.RangeSlider, _extends__default["default"]({}, input, {
    max: field.max,
    min: field.min,
    step: field.step
  }));
...
function PositionPickerInput(_ref) {
  ...
  return /*#__PURE__*/React__default["default"].createElement(_StyledRadixRadioGroupRoot, {
    value: position,
    onValueChange: newPosition => {
      onPositionChange(newPosition);
    },
    $_css: designSystem.Colors.black10
  }, positions.map(p => {
    const [vertical, horizontal] = p.value.split("-");
    return /*#__PURE__*/React__default["default"].createElement(_StyledRadixRadioGroupItem, {
      value: p.value,
      key: p.value,
      "aria-label": p.label,
      $_css2: horizontalPositionToFlexJustifyContentValue(horizontal),
      $_css3: verticalPositionToFlexAlignItemsValue(vertical),
      $_css4: p.value === position ? 1 : 0.5
    }, /*#__PURE__*/React__default["default"].createElement(_StyledDiv$1, null), /*#__PURE__*/React__default["default"].createElement(_StyledDiv2$1, {
      $_css5: horizontalPositionToFlexJustifyContentValue(horizontal),
      $_css6: p.value === position ? 1 : 0
...
const PositionIndicator = styled__default["default"].div.withConfig({
  displayName: "PositionPickerInput__PositionIndicator",
  componentId: "sc-wu39c-0"
...
//   <PositionIndicator />
// </div> */}
var _StyledRadixRadioGroupRoot = styled__default["default"](RadixRadioGroup__namespace.Root).withConfig({
  displayName: "PositionPickerInput___StyledRadixRadioGroupRoot",
  componentId: "sc-wu39c-1"
})(["display:grid;grid-template-rows:repeat(3,1fr);grid-template-columns:repeat(3,1fr);gap:0;border-radius:2px;border:1px solid ", ";"], p => p.$_css);
var _StyledRadixRadioGroupItem = styled__default["default"](RadixRadioGroup__namespace.Item).withConfig({
  displayName: "PositionPickerInput___StyledRadixRadioGroupItem",
  componentId: "sc-wu39c-2"
})(["all:unset;position:relative;display:flex;justify-content:", ";align-items:", ";box-sizing:border-box;width:20px;height:20px;padding:8px;&:hover > div{opacity:", "};}"], p => p.$_css2, p => p.$_css3, p => p.$_css4);
var _StyledDiv$1 = styled__default["default"]("div").withConfig({
  displayName: "PositionPickerInput___StyledDiv",
  componentId: "sc-wu39c-3"
})(["width:2px;height:2px;background-color:#d9d9d9;"]);
var _StyledDiv2$1 = styled__default["default"]("div").withConfig({
  displayName: "PositionPickerInput___StyledDiv2",
  componentId: "sc-wu39c-4"
})(["position:absolute;top:2px;left:2px;display:flex;flex-direction:column;justify-content:center;align-items:", ";gap:2px;width:16px;height:16px;opacity:", ";"], p => p.$_css5, p => p.$_css6);
        ...
        normalizedFieldName.forEach((path, fieldIndex) => {
          ...
          if (hasLocaleToken(path)) {
            ...
            if (currentLocaleValue === undefined) {
              const fallbackLocale = core.getFallbackLocaleForLocale(contextParams.locale, locales);
          ...
          if (parentDefinition && parentDefinition.change) {
            ...
            parentDefinition.schema.forEach(schemaProp => {
              ...
              values[schemaProp.prop] = core.isTrulyResponsiveValue(val) ? val[editorContext.breakpointIndex] : val;
              closestDefinedValues[schemaProp.prop] = core.responsiveValueGetDefinedValue(val, editorContext.breakpointIndex, editorContext.devices, core.getDevicesWidths(editorContext.devices));
            });
            const inputValue = core.isTrulyResponsiveValue(parsedValue) ? parsedValue[editorContext.breakpointIndex] : parsedValue;
            ...
            parentDefinition.schema.forEach(schemaProp => {
              ...
              if (core.isTrulyResponsiveValue(config[schemaProp.prop])) {
    ...
    getValue() {
      const fieldValues = normalizedFieldName.map(fieldName => {
        ...
        if (hasLocaleToken(fieldName)) {
          ...
          const fallbackLocale = core.getFallbackLocaleForLocale(editorContext.contextParams.locale, editorContext.locales);
...
function FieldBuilder(_ref) {
  ...
  return /*#__PURE__*/React__default["default"].createElement(FieldMetaWrapper, {
    ...
    field: field,
    layout: "column"
  }, /*#__PURE__*/React__default["default"].createElement(designSystem.Typography, null, "Unrecognized field type"));
}
function FieldsBuilder(_ref2) {
  ...
  const horizontalLine = /*#__PURE__*/React__default["default"].createElement(_StyledDiv, {
    $_css: designSystem.Colors.black10
  });
  ...
  return /*#__PURE__*/React__default["default"].createElement(FieldsGroup, null, identityField !== undefined && /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, /*#__PURE__*/React__default["default"].createElement(FieldBuilder, {
    ...
    key: groupName
  }, /*#__PURE__*/React__default["default"].createElement(FieldsGroupLabel, null, groupName), grouped[groupName].map((field, index, fields) => /*#__PURE__*/React__default["default"].createElement(_StyledDiv2, {
    key: generateFieldKey(field, breakpointIndex),
    $_css2: index === fields.length - 1 ? "8px" : 0
  }, /*#__PURE__*/React__default["default"].createElement(FieldBuilder, {
    field: field,
    form: form,
    isLabelHidden: field.schemaProp.isLabelHidden
  }))), horizontalLine)), ungrouped.map((field, index, fields) => /*#__PURE__*/React__default["default"].createElement(_StyledDiv3, {
    key: generateFieldKey(field, breakpointIndex),
    $_css3: index === fields.length - 1 ? "8px" : 0
  }, /*#__PURE__*/React__default["default"].createElement(FieldBuilder, {
    field: field,
    form: form,
    isLabelHidden: field.schemaProp.isLabelHidden
...
const FieldsGroupLabel = styled__default["default"].div.withConfig({
  displayName: "fields-builder__FieldsGroupLabel",
  componentId: "sc-yjq3oz-0"
})(["display:flex;align-items:center;padding:20px 16px 10px 16px;", ";color:#000;"], designSystem.Fonts.label);
const FieldsGroup = styled__default["default"].div.withConfig({
  displayName: "fields-builder__FieldsGroup",
  componentId: "sc-yjq3oz-1"
...
var _StyledDiv = styled__default["default"]("div").withConfig({
  displayName: "fields-builder___StyledDiv",
  componentId: "sc-yjq3oz-2"
})(["height:1px;margin-top:-1px;background-color:", ";"], p => p.$_css);
var _StyledDiv2 = styled__default["default"]("div").withConfig({
  displayName: "fields-builder___StyledDiv2",
  componentId: "sc-yjq3oz-3"
})(["margin-bottom:", ";"], p => p.$_css2);
var _StyledDiv3 = styled__default["default"]("div").withConfig({
  displayName: "fields-builder___StyledDiv3",
  componentId: "sc-yjq3oz-4"
})(["margin-bottom:", ";"], p => p.$_css3);
...
const StyleReset = styled__default["default"].div.withConfig({
  displayName: "Styles__StyleReset",
  componentId: "sc-10vjkee-0"
})(["", ""], tina_reset_styles);

const Button = styled__default["default"].button.withConfig({
  displayName: "Button",
  componentId: "sc-1uxq851-0"
...
const ICON_SIZE = 23;
const IconButton = styled__default["default"](Button).withConfig({
  displayName: "Button__IconButton",
  componentId: "sc-1uxq851-1"
...
const FormBody = styled__default["default"].div.withConfig({
  displayName: "inline-settings__FormBody",
  componentId: "sc-2rpau4-0"
...
const Wrapper$1 = styled__default["default"].div.withConfig({
  displayName: "inline-settings__Wrapper",
  componentId: "sc-2rpau4-1"
})(["display:block;margin:0 auto;width:100%;height:100%;overflow-y:auto;"]);

const Error$1 = styled__default["default"].div.withConfig({
  displayName: "EditorSidebar__Error",
  componentId: "sc-19oqwws-0"
})(["", " padding:7px 6px 7px;color:hsl(0deg 0% 50% / 0.8);white-space:normal;background:hsl(0deg 100% 50% / 0.2);margin-right:10px;border-radius:2px;margin:16px;"], designSystem.Fonts.body);
...
const Label = styled__default["default"].div.withConfig({
  ...
  componentId: "sc-1shogwk-1"
})(["background:", ";height:24px;", " display:flex;justify-content:center;align-items:center;padding-left:12px;padding-right:12px;border-radius:12px;color:white;"], designSystem.Colors.purple, designSystem.Fonts.label);
const TopBarLeft = styled__default["default"].div.withConfig({
  displayName: "EditorTopBar__TopBarLeft",
  componentId: "sc-1shogwk-2"
})(["position:absolute;top:0;left:4px;height:100%;display:flex;flex-direction:row;align-items:center;gap:4px;"]);
const TopBarRight = styled__default["default"].div.withConfig({
  displayName: "EditorTopBar__TopBarRight",
  componentId: "sc-1shogwk-3"
})(["position:absolute;top:0;right:8px;height:100%;display:flex;flex-direction:row;align-items:center;gap:16px;"]);
const TopBarCenter = styled__default["default"].div.withConfig({
  displayName: "EditorTopBar__TopBarCenter",
  componentId: "sc-1shogwk-4"
...
const EditorTopBar = _ref => {
  ...
  return /*#__PURE__*/React__default["default"].createElement(TopBar, {
    ref: headingRef
  }, /*#__PURE__*/React__default["default"].createElement(TopBarLeft, null, !hideCloseButton && /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, /*#__PURE__*/React__default["default"].createElement(designSystem.ButtonGhost, {
    icon: designSystem.Icons.Close,
    hideLabel: true,
    onClick: () => {
      if (onClose) {
        onClose();
    ...
    style: {
      height: "100%",
      background: designSystem.Colors.black10,
      width: 1
    }
  })), /*#__PURE__*/React__default["default"].createElement(designSystem.ButtonGhost, {
    icon: designSystem.Icons.Undo,
    hideLabel: true,
    onClick: () => {
      onUndo();
    }
  }, "Undo"), /*#__PURE__*/React__default["default"].createElement(designSystem.ButtonGhost, {
    icon: designSystem.Icons.Redo,
    hideLabel: true,
    onClick: () => {
      onRedo();
    }
  ...
  }, /*#__PURE__*/React__default["default"].createElement(designSystem.Typography, {
    variant: "body",
    component: "label",
    htmlFor: "easyblocks-edit-mode-button"
  }, "Edit mode"), " ", /*#__PURE__*/React__default["default"].createElement(designSystem.Toggle, {
...
function DeviceSwitch(_ref2) {
  ...
  return /*#__PURE__*/React__default["default"].createElement(designSystem.ToggleGroup, {
    value: deviceId,
    onChange: deviceId => {
      if (deviceId === "") {
        return;
    ...
    return /*#__PURE__*/React__default["default"].createElement(designSystem.Tooltip, {
      key: d.id
    }, /*#__PURE__*/React__default["default"].createElement(designSystem.TooltipTrigger, null, /*#__PURE__*/React__default["default"].createElement(designSystem.ToggleGroupItem, {
      value: d.id
    }, DEVICE_ID_TO_ICON[d.id])), /*#__PURE__*/React__default["default"].createElement(designSystem.TooltipContent, null, /*#__PURE__*/React__default["default"].createElement(designSystem.Typography, {
      color: "white"
    }, d.label ?? d.id)));
  }), /*#__PURE__*/React__default["default"].createElement(designSystem.Tooltip, null, /*#__PURE__*/React__default["default"].createElement(designSystem.TooltipTrigger, null, /*#__PURE__*/React__default["default"].createElement(designSystem.ToggleGroupItem, {
    value: "fit-screen"
  }, DEVICE_ID_TO_ICON["fit-screen"])), /*#__PURE__*/React__default["default"].createElement(designSystem.TooltipContent, null, /*#__PURE__*/React__default["default"].createElement(designSystem.Typography, {
    color: "white"
  }, "Fit screen"))));
}
...
function getAllComponentsOfTypeFromDefinitionsArray(type, definitions) {
  return definitions.filter(definition => core.isNoCodeComponentOfType(definition, type));
}
...
const TemplateModal = props => {
  ...
  const toaster = designSystem.useToaster();
  ...
  return /*#__PURE__*/React__default["default"].createElement(designSystem.Modal, {
  ...
  }, /*#__PURE__*/React__default["default"].createElement(designSystem.FormElement, {
    name: "label",
    label: "Template name"
  }, /*#__PURE__*/React__default["default"].createElement(designSystem.Input, {
  ...
  }, /*#__PURE__*/React__default["default"].createElement("div", null, mode === "edit" && /*#__PURE__*/React__default["default"].createElement(designSystem.ButtonDanger, {
    onClick: e => {
      e.preventDefault();
  ...
  }, "Delete")), /*#__PURE__*/React__default["default"].createElement(designSystem.ButtonPrimary, {
    type: "submit",
    disabled: !canSend,
...
function removeItems(form, fieldNamesToRemove, compilationContext) {
  ...
  if (!isRemovingMultipleFields) {
    ...
    const isTextWrapper = definition && core.isNoCodeComponentOfType(definition, "@easyblocks/text-wrapper");
...
function configMapInternal(config, context, callback, prefix) {
  ...
  componentDefinition.schema.forEach(schemaProp => {
    if (schemaProp.type === "component-collection-localised") {
      ...
      if (core.isTrulyResponsiveValue(result[schemaProp.prop])) {
        const mappedVal = {
          $res: true
        };
...
function getDefaultTemplateForDefinition(def, editorContext) {
  ...
  const config = def.id === "@easyblocks/rich-text" ? core.buildRichTextNoCodeEntry({
  ...
  return configMap(config, editorContext, _ref2 => {
    ...
    if (schemaProp.type === "text") {
      ...
      return {
        ...value,
        value: {
          [core.getDefaultLocale(editorContext.locales).code]: firstDefinedValue
        }
      };
...
function checkLocalesCorrectness(locales) {
  ...
  locales.forEach(locale => {
    ...
    do {
      ...
      const fallbackId = currentLocale.fallback ?? core.getDefaultLocale(locales).code;

      // If we got to the default locale then we're fine
      if (fallbackId === core.getDefaultLocale(locales).code) {
        break;
      }
...
const ContentContainer = styled__default["default"].div.withConfig({
  displayName: "Editor__ContentContainer",
  componentId: "sc-1160gud-0"
})(["position:relative;flex:1 1 auto;display:flex;flex-direction:column;"]);
const SidebarAndContentContainer = styled__default["default"].div.withConfig({
  displayName: "Editor__SidebarAndContentContainer",
  componentId: "sc-1160gud-1"
...
const SidebarContainer = styled__default["default"].div.withConfig({
  displayName: "Editor__SidebarContainer",
  componentId: "sc-1160gud-2"
})(["flex:0 0 240px;background:", ";border-left:1px solid ", ";box-sizing:border-box;> *{box-sizing:border-box;}overflow-y:auto;"], designSystem.Colors.white, designSystem.Colors.black100);
const DataSaverRoot = styled__default["default"].div.withConfig({
  displayName: "Editor__DataSaverRoot",
  componentId: "sc-1160gud-3"
})(["position:fixed;width:100%;height:100%;z-index:100000;display:flex;justify-content:center;align-items:center;"]);
const DataSaverOverlay = styled__default["default"].div.withConfig({
  displayName: "Editor__DataSaverOverlay",
  componentId: "sc-1160gud-4"
})(["z-index:-1;position:absolute;top:0;left:0;width:100%;height:100%;background:rgba(0,0,0,0.25);"]);
const DataSaverModal = styled__default["default"].div.withConfig({
  displayName: "Editor__DataSaverModal",
  componentId: "sc-1160gud-5"
})(["background:white;padding:32px;border-radius:8px;display:flex;justify-content:center;align-items:center;", " font-size:16px;"], designSystem.Fonts.body);
const AuthenticationScreen = styled__default["default"].div.withConfig({
  displayName: "Editor__AuthenticationScreen",
  componentId: "sc-1160gud-6"
})(["width:100vw;height:100vh;display:flex;flex-direction:column;justify-content:center;align-items:center;gap:24px;text-align:center;", ""], designSystem.Fonts.bodyLarge);
...
const EditorWrapper = /*#__PURE__*/React.memo(props => {
  ...
  const locale = props.locale ?? core.getDefaultLocale(props.config.locales).code;
  ...
  const compilationContext = core.createCompilationContext(props.config, {
    locale
  }, rootComponentId);
  const initialEntry = props.document ? adaptRemoteConfig(props.document.entry, compilationContext) : core.normalize(rootTemplateEntry ?? {
    _id: uniqueId(),
...
function useBuiltContent(editorContext, config, rawContent, externalData, onExternalDataChange) {
  ...
  if (!buildEntryResult.current || inputChanged) {
    ...
    buildEntryResult.current = core.buildEntry({
      entry: rawContent,
      config,
      locale: editorContext.contextParams.locale,
      externalData,
      compiler: {
        findExternals: core.findExternals,
        ...
        compile: content => {
          ...
          const normalizedContent = core.normalizeInput(content);
          const {
            meta,
            ...rest
          } = core.compileInternal(normalizedContent, editorContext, editorContext.compilationCache);
          resultMeta = core.mergeCompilationMeta(resultMeta, meta);
          return {
            ...rest,
            meta: resultMeta
          };
      ...
      isExternalDataChanged(externalDataValue, defaultIsExternalDataChanged) {
        ...
        if (storedExternalData && externalDataValue.externalId && inputRawContent.current) {
          ...
          const value = breakpointIndex ? core.responsiveValueGet(config[fieldName], breakpointIndex) : config[fieldName];
...
const EditorContent = _ref => {
  ...
  const compilationCache = React.useRef(new core.CompilationCache());
...
function adaptRemoteConfig(config, compilationContext) {
  ...
  const normalized = core.normalize(withoutLocalizedFlag, compilationContext);
  return normalized;
}
...
function DocumentDataWidgetComponent(_ref) {
  ...
  if (id !== null && typeof id !== "string") {
    return /*#__PURE__*/React__default["default"].createElement(_StyledTypography, null, "Unsupported type of identifier for document data widget. Expected \"string\", but got \"", typeof id, "\".");
  }
  const {
    editorContext,
    externalData
  ...
  const documentExternalLocationKeys = assertDefined(schema).map(s => core.getExternalReferenceLocationKey("$", s.prop));
  const documentCompoundResources = Object.entries(externalData).filter(r => {
    const [externalId, externalDataValue] = r;
    return documentExternalLocationKeys.includes(externalId) && core.isResolvedCompoundExternalDataValue(externalDataValue);
  });
  ...
  if (!documentCompoundResources.length) {
    return /*#__PURE__*/React__default["default"].createElement(_StyledTypography2, null, "Please select at least one non optional external data for document.");
  }
...
var _StyledTypography = styled__default["default"](designSystem.Typography)`
          white-space: normal;
        `;
var _StyledTypography2 = styled__default["default"](designSystem.Typography).withConfig({
  displayName: "DocumentDataWidget___StyledTypography2",
  componentId: "sc-a9m8b9-0"
})(["white-space:normal;"]);
...
const CardRoot = styled__default["default"].div.withConfig({
  displayName: "SectionPicker__CardRoot",
  componentId: "sc-1qxd0kc-0"
})(["&:hover{outline:1px solid ", ";outline-offset:8px;}.editButton{opacity:0;}&:hover{.editButton{opacity:1;}}"], designSystem.Colors.black10);
const ImageContainer = styled__default["default"].div.withConfig({
  displayName: "SectionPicker__ImageContainer",
  componentId: "sc-1qxd0kc-1"
})(["position:relative;background-color:", ";margin-bottom:8px;padding-bottom:", ";cursor:pointer;"], designSystem.Colors.black10, p => p.mode === "large-3" ? "90%" : "60%");
const CardImg = styled__default["default"].img.withConfig({
  displayName: "SectionPicker__CardImg",
  componentId: "sc-1qxd0kc-2"
})(["position:absolute;top:0;left:0;width:100%;height:100%;object-fit:contain;padding:24px;box-sizing:border-box;"]);
const CardImgPlaceholder = styled__default["default"].div.withConfig({
  displayName: "SectionPicker__CardImgPlaceholder",
  componentId: "sc-1qxd0kc-3"
})(["position:absolute;top:0;left:0;width:100%;height:100%;display:flex;align-items:center;justify-content:center;"]);
const CardFooter = styled__default["default"].div.withConfig({
  displayName: "SectionPicker__CardFooter",
  componentId: "sc-1qxd0kc-4"
})(["display:flex;flex-direction:row;justify-content:space-between;align-items:center;margin-top:8px;"]);
const CardLabelContainer = styled__default["default"].div.withConfig({
  displayName: "SectionPicker__CardLabelContainer",
  componentId: "sc-1qxd0kc-5"
})(["display:flex;flex-direction:row;align-items:center;"]);
const CardLabelTemplateName = styled__default["default"].div.withConfig({
  displayName: "SectionPicker__CardLabelTemplateName",
  componentId: "sc-1qxd0kc-6"
})(["", ";color:black;"], designSystem.Fonts.body);
const Title = styled__default["default"].div.withConfig({
  displayName: "SectionPicker__Title",
  componentId: "sc-1qxd0kc-7"
})(["", ""], designSystem.Fonts.label);
const TitleContainer = styled__default["default"].div.withConfig({
  displayName: "SectionPicker__TitleContainer",
  componentId: "sc-1qxd0kc-8"
})(["display:flex;flex-direction:row;gap:8px;align-items:center;margin-bottom:24px;"]);
const Message = styled__default["default"].div.withConfig({
  displayName: "SectionPicker__Message",
  componentId: "sc-1qxd0kc-9"
})(["padding-top:32px;", ";"], designSystem.Fonts.body);
...
const SectionCard = _ref => {
  ...
  return /*#__PURE__*/React__default["default"].createElement(CardRoot, null, /*#__PURE__*/React__default["default"].createElement(ImageContainer, {
    ...
    fill: designSystem.Colors.black20
  }), /*#__PURE__*/React__default["default"].createElement("path", {
...
const Sidebar = styled__default["default"].div.withConfig({
  ...
  componentId: "sc-1qxd0kc-12"
})(["overflow-y:hidden;overflow-x:hidden;border-right:1px solid ", ";height:100%;"], designSystem.Colors.black5);
const SidebarContent = styled__default["default"].div.withConfig({
  displayName: "SectionPicker__SidebarContent",
  componentId: "sc-1qxd0kc-13"
})(["padding:24px 4px;display:flex;flex-direction:column;gap:8px;"]);
const SidebarButton = styled__default["default"].button.withConfig({
  displayName: "SectionPicker__SidebarButton",
  componentId: "sc-1qxd0kc-14"
})(["all:unset;height:38px;", " display:flex;padding-left:16px;align-items:center;&:hover{background:", ";}cursor:pointer;"], designSystem.Fonts.body, designSystem.Colors.black5);
const GridRoot = styled__default["default"].div.withConfig({
  displayName: "SectionPicker__GridRoot",
  componentId: "sc-1qxd0kc-15"
...
const SearchableSmallPickerModal = _ref => {
  ...
  return /*#__PURE__*/React__default["default"].createElement(designSystem.Modal, {
    ...
    return templates.map(template => {
      ...
      return /*#__PURE__*/React__default["default"].createElement(designSystem.BasicRow, {
        key: template.id,
        title: title,
        description: description,
        onClick: () => {
...
function EasyblocksParent(props) {
  ...
  }, /*#__PURE__*/React__default["default"].createElement(designSystem.ModalContext.Provider, {
    value: () => {
      return document.querySelector("#modalContainer");
    }
  }, /*#__PURE__*/React__default["default"].createElement(GlobalStyles, null), /*#__PURE__*/React__default["default"].createElement(designSystem.GlobalModalStyles, null), /*#__PURE__*/React__default["default"].createElement(designSystem.TooltipProvider, null, /*#__PURE__*/React__default["default"].createElement("div", {
    id: "modalContainer",
    style: {
      position: "fixed",
      left: 0,
  ...
  })), /*#__PURE__*/React__default["default"].createElement(designSystem.Toaster, {
    containerStyle: {
      zIndex: 100100
    }
  })));
...
function BlocksControls(_ref) {
  ...
  const dndContext = core$1.useDndContext();
...
function Placeholder(props) {
  ...
  const rootClassName = stitches.css({
    border: `1px dashed ${designSystem.Colors.blue50}`,
    position: "relative",
  ...
  const contentClassName = stitches.css({
    ...
    height: "100%",
    display: "flex",
    color: designSystem.Colors.blue50,
    justifyContent: "center",
    alignItems: "center",
    cursor: "pointer",
    ...designSystem.Fonts.body,
    "&:hover": {
      backgroundColor: designSystem.Colors.blue10
    },
...
function customCollisionDetection(args) {
  ...
  const pointerCollisions = core$1.pointerWithin(args);
  ...
  return core$1.rectIntersection(args);
}
function EasyblocksCanvas(_ref) {
  ...
  const mouseSensor = core$1.useSensor(core$1.MouseSensor, {
  ...
  return /*#__PURE__*/ /* EasyblocksMetadataProvider must be defined in case of nested <Easyblocks /> components are used! */React__default["default"].createElement(_internals.EasyblocksMetadataProvider, {
    meta: meta
  }, /*#__PURE__*/React__default["default"].createElement(CanvasRoot, null, /*#__PURE__*/React__default["default"].createElement(core$1.DndContext, {
    sensors: [mouseSensor],
    ...
    items: sortableItems
  }, /*#__PURE__*/React__default["default"].createElement(core.Easyblocks, {
    renderableDocument: {
...
const PreviewRenderer = props => {
  ...
  React.useEffect(() => {
    ...
    const localeWithDefault = locale ?? core.getDefaultLocale(config.locales ?? []).code;
    (async () => {
      const {
        buildDocument,
        buildEntry
      } = await Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require('@easyblocks/core')); });
      if (mode === "document") {
        const {
          renderableDocument,
          externalData
