...
function FieldMetaWrapper(_ref) {
  ...
  const content = /*#__PURE__*/React__default.createElement(_StyledDiv$5, {
  ...
  }, triggerProps), /*#__PURE__*/React__default.createElement(_StyledSpan$1, null, label), isOpen && /*#__PURE__*/React__default.createElement(Tooltip, tooltipProps, /*#__PURE__*/React__default.createElement(TooltipArrow, arrowProps), /*#__PURE__*/React__default.createElement(TooltipBody, null, field.description))), isLoadingExternalValue && /*#__PURE__*/React__default.createElement(_StyledLoader, null), resolvedLayout === "column" && (isExternalSchemaProp(schemaProp, editorContext.types) || schemaProp.type === "text") && !isMixedValue && /*#__PURE__*/React__default.createElement(WidgetsSelect, {
...
function TokenFieldComponent(_ref) {
  ...
  const isExtraValueSelected = !isMixedFieldValue(input.value) && !input.value.tokenId && extraValuesIncludes(extraValues, responsiveValueGetDefinedValue(input.value.value, editorContext.breakpointIndex, editorContext.devices, getDevicesWidths(editorContext.devices) /** FOR NOW TOKENS ARE RELATIVE TO SCREEN **/));
  ...
  const onSelectChange = selectedValue => {
    if (selectedValue === CUSTOM_OPTION_VALUE) {
      ...
      if (isTrulyResponsiveValue(value)) {
        ...
        value, editorContext.breakpointIndex, editorContext.devices, getDevicesWidths(editorContext.devices) /** FOR NOW TOKENS ARE RELATIVE TO SCREEN **/);
      }
      input.onChange({
        value,
...
function getFontTokenLabel(name, token, editorContext) {
  const filledResponsiveFontValue = responsiveValueFill(token.value, editorContext.devices, getDevicesWidths(editorContext.devices));
  const currentDeviceFontValue = responsiveValueForceGet(filledResponsiveFontValue, editorContext.breakpointIndex);
...
const SelectColorTokenItem = /*#__PURE__*/forwardRef((props, ref) => {
  return /*#__PURE__*/React__default.createElement(SelectItem, {
    ...
    ref: ref
  }, /*#__PURE__*/React__default.createElement(_StyledSpan, null, /*#__PURE__*/React__default.createElement("svg", {
...
const BlockField = _ref => {
  ...
  return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, !isLabelHidden && /*#__PURE__*/React__default.createElement(_StyledDiv$4, null, /*#__PURE__*/React__default.createElement(Typography, null, field.label || field.name)), /*#__PURE__*/React__default.createElement(_StyledDiv2$4, null, config !== null && /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement("div", {
    style: {
      flex: "1 1 auto",
      minWidth: 0
    }
...
function AddButton$1(_ref2) {
  ...
  return /*#__PURE__*/React__default.createElement(_StyledButtonGhost$1, {
    onClick: onAdd,
    height: "32px",
    noPadding: true
  }, /*#__PURE__*/React__default.createElement(_StyledDiv3$2, null, /*#__PURE__*/React__default.createElement(_StyledDiv4, {
    $_css: Colors.black20
...
function getSidebarPreview(componentDefinition, entryAfterAuto, externalData, editorContext) {
  const previewValues = Object.fromEntries(componentDefinition.schema.map(s => {
    const value = responsiveValueForceGet(entryAfterAuto[s.prop], editorContext.breakpointIndex);
    if (isExternalSchemaProp(s, editorContext.types)) {
      const externalDataValue = resolveExternalValue(value, entryAfterAuto._id, s, externalData);
      return [s.prop, externalDataValue];
    }
    if (s.type === "text") {
      return [s.prop, resolveLocalisedValue(value.value, editorContext)?.value];
    }
    return [s.prop, value];
  }));
...
var _StyledDiv2$4 = styled("div").withConfig({
...
var _StyledButtonGhost$1 = styled(ButtonGhost).withConfig({
  displayName: "BlockFieldPlugin___StyledButtonGhost",
  componentId: "sc-1xayyaw-5"
})(["width:100%;padding-left:0;"]);
var _StyledDiv3$2 = styled("div").withConfig({
...
function IdentityField(_ref) {
  ...
  const titleContent = /*#__PURE__*/React__default.createElement(_StyledDiv$3, null, /*#__PURE__*/React__default.createElement(_StyledTypography$1, null, componentDefinition?.label ?? componentDefinition?.id), !isNonChangable && /*#__PURE__*/React__default.createElement(Icons.ChevronDown, {
    size: 16
  }));
  return /*#__PURE__*/React__default.createElement(_StyledDiv2$3, null, /*#__PURE__*/React__default.createElement(_StyledDiv3$1, null, isWithinNestedPanel && /*#__PURE__*/React__default.createElement(_StyledButtonGhost, {
  ...
  }, titleContent), /*#__PURE__*/React__default.createElement(_StyledButtonGhost2, {
...
var _StyledDiv$3 = styled("div")`
        display: flex;
        align-items: center;
        gap: 2px;
      `;
var _StyledTypography$1 = styled(Typography)`
          line-height: 14px;
          font-weight: 700;
        `;
var _StyledDiv2$3 = styled("div")`
        display: flex;
        gap: 8px;
        min-height: 28px;
        padding: 10px;
      `;
var _StyledDiv3$1 = styled("div")`
          display: flex;
          align-items: center;
          flex: 1 0;
        `;
var _StyledButtonGhost = styled(ButtonGhost)`
              margin-right: auto;
            `;
var _StyledButtonGhost2 = styled(ButtonGhost).withConfig({
...
const ExternalFieldComponent = props => {
  ...
  const externalReferenceLocationKey = getExternalReferenceLocationKey(configId, field.schemaProp.prop, field.schemaProp.responsive ? editorContext.breakpointIndex : undefined);
  ...
  return /*#__PURE__*/React__default.createElement(FieldMetaWrapper, _extends({}, props, {
    form: tinaForm,
    layout: "column"
  }), /*#__PURE__*/React__default.createElement(_StyledDiv$2, null, isMixedFieldValue(value) ? "Mixed" : /*#__PURE__*/React__default.createElement(_StyledDiv2$2, null, ExternalField ? /*#__PURE__*/React__default.createElement(ExternalField, {
    id: value.id,
...
function responsiveFieldController(config) {
  ...
  const isResponsive = fieldValues.every(fieldValue => isTrulyResponsiveValue(fieldValue));
  ...
  const format = (value, name) => {
    ...
    const displayedValue = (isTrulyResponsiveValue(valueAfterFormat) ? valueAfterFormat[editorContext.breakpointIndex] : valueAfterFormat) ?? null;
...
function PositionPickerInput(_ref) {
  ...
  return /*#__PURE__*/React__default.createElement(_StyledRadixRadioGroupRoot, {
    value: position,
    ...
    return /*#__PURE__*/React__default.createElement(_StyledRadixRadioGroupItem, {
      value: p.value,
      key: p.value,
      "aria-label": p.label,
    ...
    }, /*#__PURE__*/React__default.createElement(_StyledDiv$1, null), /*#__PURE__*/React__default.createElement(_StyledDiv2$1, {
...
//   <PositionIndicator />
// </div> */}
var _StyledRadixRadioGroupRoot = styled(RadixRadioGroup.Root).withConfig({
...
var _StyledRadixRadioGroupItem = styled(RadixRadioGroup.Item).withConfig({
        ...
        normalizedFieldName.forEach((path, fieldIndex) => {
          ...
          if (hasLocaleToken(path)) {
            ...
            if (currentLocaleValue === undefined) {
              const fallbackLocale = getFallbackLocaleForLocale(contextParams.locale, locales);
          ...
          if (parentDefinition && parentDefinition.change) {
            ...
            parentDefinition.schema.forEach(schemaProp => {
              ...
              values[schemaProp.prop] = isTrulyResponsiveValue(val) ? val[editorContext.breakpointIndex] : val;
              closestDefinedValues[schemaProp.prop] = responsiveValueGetDefinedValue(val, editorContext.breakpointIndex, editorContext.devices, getDevicesWidths(editorContext.devices));
            });
            const inputValue = isTrulyResponsiveValue(parsedValue) ? parsedValue[editorContext.breakpointIndex] : parsedValue;
...
function FieldsBuilder(_ref2) {
  ...
  const horizontalLine = /*#__PURE__*/React__default.createElement(_StyledDiv, {
    $_css: Colors.black10
  });
  ...
  return /*#__PURE__*/React__default.createElement(FieldsGroup, null, identityField !== undefined && /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(FieldBuilder, {
    ...
    key: groupName
  }, /*#__PURE__*/React__default.createElement(FieldsGroupLabel, null, groupName), grouped[groupName].map((field, index, fields) => /*#__PURE__*/React__default.createElement(_StyledDiv2, {
  ...
  }))), horizontalLine)), ungrouped.map((field, index, fields) => /*#__PURE__*/React__default.createElement(_StyledDiv3, {
    key: generateFieldKey(field, breakpointIndex),
    ...
    buildEntryResult.current = buildEntry({
      ...
      isExternalDataChanged(externalDataValue, defaultIsExternalDataChanged) {
        ...
        if (storedExternalData && externalDataValue.externalId && inputRawContent.current) {
          ...
          const value = breakpointIndex ? responsiveValueGet(config[fieldName], breakpointIndex) : config[fieldName];
...
const EditorContent = _ref => {
  ...
  }, isDataSaverOverlayOpen && /*#__PURE__*/React__default.createElement(DataSaverRoot, null, /*#__PURE__*/React__default.createElement(DataSaverOverlay, null), /*#__PURE__*/React__default.createElement(DataSaverModal, null, "Saving data, please do not close the window...")), /*#__PURE__*/React__default.createElement(EditorContext.Provider, {
    value: editorContext
...
function DocumentDataWidgetComponent(_ref) {
  ...
  if (id !== null && typeof id !== "string") {
    return /*#__PURE__*/React__default.createElement(_StyledTypography, null, "Unsupported type of identifier for document data widget. Expected \"string\", but got \"", typeof id, "\".");
  }
  const {
    editorContext,
    externalData
  ...
  const documentExternalLocationKeys = assertDefined(schema).map(s => getExternalReferenceLocationKey("$", s.prop));
  ...
  if (!documentCompoundResources.length) {
    return /*#__PURE__*/React__default.createElement(_StyledTypography2, null, "Please select at least one non optional external data for document.");
  }
...
var _StyledTypography = styled(Typography)`
          white-space: normal;
        `;
var _StyledTypography2 = styled(Typography).withConfig({
...
const PreviewRenderer = props => {
  ...
  useEffect(() => {
    ...
    const localeWithDefault = locale ?? getDefaultLocale(config.locales ?? []).code;
    (async () => {
      const {
        buildDocument,
        buildEntry
      } = await import('@easyblocks/core');
      if (mode === "document") {
        const {
          renderableDocument,
          externalData
